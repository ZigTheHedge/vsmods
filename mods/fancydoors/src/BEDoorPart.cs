...
{
    abstract class BEDoorPart : BlockEntityContainer
    {
        ...
        protected DoorRenderer doorRenderer;
        ...
        {
            BEDoorPart be = world.BlockAccessor.GetBlockEntity(pos) as BEDoorPart;
            if (be != null) be.OpenCloseDoor(world, ignoreSide);
        }

        public abstract void OpenCloseDoor(IWorldAccessor world, string ignoreSide);
        ...
        protected MeshData getMesh(int index)
        {
            MeshData mesh;
            ICoreClientAPI capi = Api as ICoreClientAPI;
        ...
        public virtual MeshData TransformMesh(MeshData meshData)
        {
        ...
        public virtual Cuboidf GetCollision()
        {
            float width = 0;
