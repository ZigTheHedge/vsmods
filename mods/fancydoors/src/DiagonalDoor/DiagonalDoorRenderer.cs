...
{
    class DiagonalDoorRenderer : DoorRenderer
    {
        public DiagonalDoorRenderer(BlockPos pos, ICoreClientAPI api, BEDoorPart BE) : base(pos, api, BE)
        {
        }
